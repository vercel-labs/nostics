...
describe('defineDiagnostics', () => {
  ...
  it('extend() adds new codes', () => {
    ...
    expect(extended.B9999().message).toBe('Extended diagnostic.')
    expect(extended.B1001().code).toBe('B1001')
  })
